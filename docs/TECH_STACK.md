...
This document provides a detailed overview of the technologies, libraries, and versions used in **Skigebiet-Finder v1.7.1**, along with the rationale for their selection.
...
*Last Updated: 2026-01-07 (v1.7.1)*
